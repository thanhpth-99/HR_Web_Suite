    ...
    <div class="head-menu border-0 border-bottom border-secondary-subtle col-12">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="pagination d-flex justify-content-center align-items-center">
                ...
                <button class="btn btn-secondary rounded-0 me-1" :disabled="currentPage === 1" @click="$emit('prevPage')">
                    &lt;&lt;
                </button>
                <button
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a
                            ...
                            :class="{ 'active bg-primary': activeTab === 'table' }"
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link text-dark"
                            :class="{ 'active bg-primary': activeTab === 'card' }"
